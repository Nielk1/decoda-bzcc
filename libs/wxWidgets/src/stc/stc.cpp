...
wxDEFINE_EVENT(wxEVT_STC_ON_CONTEXT_MENU, wxStyledTextEvent);
...
BEGIN_EVENT_TABLE(wxStyledTextCtrl, wxControl)
    ...
    EVT_MENU                    (wxID_ANY, wxStyledTextCtrl::OnMenu)
...
void wxStyledTextCtrl::AddToPopUp(const char *label, int cmd, bool enabled)
{
  m_swx->AddToPopUp(label, cmd, enabled);
}
