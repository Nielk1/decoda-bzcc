...
public:
    ...
    int FindText(int minPos, int maxPos, const wxString& text, int flags = 0, int* lengthFound = nullptr);
...
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_STC,  wxEVT_STC_AUTOCOMP_DWELLSTART, wxStyledTextEvent);
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_STC, wxEVT_STC_AUTOCOMP_DWELLEND, wxStyledTextEvent);
...
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_STC, wxEVT_STC_DO_CONTEXT_COMMAND, wxStyledTextEvent );
wxDECLARE_EXPORTED_EVENT( WXDLLIMPEXP_STC, wxEVT_STC_ON_CONTEXT_MENU, wxStyledTextEvent );
#else
    enum {
        wxEVT_STC_CHANGE,
        ...
        wxEVT_STC_AUTOCOMP_DWELLSTART,
        wxEVT_STC_AUTOCOMP_DWELLEND,
...
#define EVT_STC_AUTOCOMP_DWELLSTART(id, fn)wxDECLARE_EVENT_TABLE_ENTRY( wxEVT_STC_AUTOCOMP_DWELLSTART,   id, wxID_ANY, wxStyledTextEventHandler( fn ), (wxObject *) NULL ),
#define EVT_STC_AUTOCOMP_DWELLEND(id, fn)  wxDECLARE_EVENT_TABLE_ENTRY( wxEVT_STC_AUTOCOMP_DWELLEND,     id, wxID_ANY, wxStyledTextEventHandler( fn ), (wxObject *) NULL ),
...
#define EVT_STC_DO_CONTEXT_COMMAND(id, fn) wxDECLARE_EVENT_TABLE_ENTRY( wxEVT_STC_DO_CONTEXT_COMMAND,    id, wxID_ANY, wxStyledTextEventHandler( fn ), (wxObject *) NULL ),
#define EVT_STC_ON_CONTEXT_MENU(id, fn)    wxDECLARE_EVENT_TABLE_ENTRY( wxEVT_STC_ON_CONTEXT_MENU,       id, wxID_ANY, wxStyledTextEventHandler( fn ), (wxObject *) NULL ),
