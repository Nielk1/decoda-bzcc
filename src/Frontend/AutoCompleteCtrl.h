...
#ifndef AUTOCOMPLETE_CTRL_H
#define AUTOCOMPLETE_CTRL_H
...
/**
 * AutoComplete control. This is the base class for the tree controls used to display
 * the results of evaluating expressions.
 */
class AutoCompleteCtrl : public wxTreeListCtrl
{

public:

    AutoCompleteCtrl(wxWindow* parent, wxWindowID id = -1, const wxPoint& pos = wxDefaultPosition, const wxSize& size = wxDefaultSize,
